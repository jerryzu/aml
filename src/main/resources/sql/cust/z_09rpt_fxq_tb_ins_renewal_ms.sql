...
alter table rpt_fxq_tb_ins_renewal_ms add partition (partition pt20190903000000 values less than ('{lastday}999999'));

alter table rpt_fxq_tb_ins_renewal_ms truncate partition pt20190903000000;
*/
...
from ods_cthx_web_ply_base partition(pt20190903000000) a
	...
	inner join ods_cthx_web_prd_prod partition(pt20190903000000) p on a.c_prod_no=p.c_prod_no
