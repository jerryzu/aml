...
alter table rpt_fxq_tb_ins_rcla_ms add partition (partition pt20190922000000 values less than ('20190922999999'));

alter table rpt_fxq_tb_ins_rcla_ms truncate partition pt20190922000000;
*/
...
from ods_cthx_web_ply_base partition(pt20190922000000) a
	 ...
	 inner join ods_cthx_web_clmnv_endcase partition(pt20190922000000) u on a.c_ply_no = u.c_clm_no -- and u.c_feetyp_cde ='CPPK'
	 inner join ods_cthx_web_clm_bank partition(pt20190922000000) g on u.c_clm_no=g.c_clm_no
	 inner join ods_cthx_web_clm_rpt partition(pt20190922000000) e on g.c_clm_no=e.c_clm_no
