...
alter table rpt_fxq_tb_ins_rchg_ms add partition (partition pt20190928000000 values less than ('20190928999999'));

alter table rpt_fxq_tb_ins_rchg_ms truncate partition pt20190928000000;
*/
...
from ods_cthx_web_ply_base partition(pt20190928000000) a
	...
	inner join ods_cthx_web_bas_edr_rsn   partition(pt20190928000000) c on a.c_edr_rsn_bundle_cde=c.c_rsn_cde and substr(a.c_prod_no,1,2)=c.c_kind_no
