...
alter table rpt_fxq_tb_ins_rpay_ms add partition (partition pt20190928000000 values less than ('20190928999999'));

alter table rpt_fxq_tb_ins_rpay_ms truncate partition pt20190928000000;
*/
...
from ods_cthx_web_ply_base partition(pt20190928000000) a
    inner join ods_cthx_web_fin_prm_due partition(pt20190928000000) due on a.c_ply_no = due.c_ply_no
    inner join ods_cthx_web_fin_cav_mny partition(pt20190928000000) mny on due.c_cav_no = mny.c_cav_pk_id
