...
alter table rpt_fxq_tb_ins_rpol_ms add partition (partition pt20190827000000 values less than ('{lastday}999999'));

alter table rpt_fxq_tb_ins_rpol_ms truncate partition pt20190827000000;
*/
...
select 
        ...
        -- select concat('when ''', c_cde, ''' then '' '' -- ',  c_cnm) from ods_cthx_web_bas_comm_code partition(pt20190827000000) where c_par_cde = '601' order by c_cde 
...
from ods_cthx_web_ply_base partition(pt20190827000000) a
        left join ods_cthx_web_ply_insured partition(pt20190827000000) id on a.c_ply_no=id.c_ply_no
        left join edw_cust_ply_party partition(pt20190827000000) pa on a.c_ply_no=pa.c_ply_no and pa.c_biz_type =  21 -- 10: 收款人, 21: 投保人, 22: 法人投保人, 31:被保人, 32:法人被保人, 33: 团单被保人，41: 受益人, 42: 法人受益人, 43: 团单受益人
        left join edw_cust_pers_info partition(pt20190827000000) a1 on pa.c_cst_no =a1.c_cst_no

        left join edw_cust_ply_party partition(pt20190827000000) pi on a.c_ply_no=pi.c_ply_no and pi.c_biz_type =  31 -- 10: 收款人, 21: 投保人, 22: 法人投保人, 31:被保人, 32:法人被保人, 33: 团单被保人，41: 受益人, 42: 法人受益人, 43: 团单受益人
        left join edw_cust_pers_info partition(pt20190827000000) i on pi.c_cst_no =i.c_cst_no
        
        left join edw_cust_ply_party partition(pt20190827000000) pb on a.c_ply_no=pb.c_ply_no and pb.c_biz_type =  41 -- 10: 收款人, 21: 投保人, 22: 法人投保人, 31:被保人, 32:法人被保人, 33: 团单被保人，41: 受益人, 42: 法人受益人, 43: 团单受益人
        left join edw_cust_pers_info partition(pt20190827000000) b on pb.c_cst_no =b.c_cst_no
        
	-- left join ods_cthx_web_prd_prod partition(pt20190827000000) c on a.c_prod_no=c.c_prod_no
