...
alter table rpt_fxq_tb_ins_rpol_ms add partition (partition pt20190903000000 values less than ('{lastday}999999'));

alter table rpt_fxq_tb_ins_rpol_ms truncate partition pt20190903000000;
*/
...
select 
        ...
        case ifnull((select c_kind_no from ods_cthx_web_prd_prod partition(pt20190903000000)  v where v.c_prod_no = a.c_prod_no), 1)
                when '1' then
        ...
        (select c_cha_nme from ods_cthx_web_cus_cha partition(pt20190903000000)  v where v.c_cha_cde = a.c_brkr_cde) as sale_name,-- 销售渠道名称
        ...
        -- select concat('when ''', c_cde, ''' then '' '' -- ',  c_cnm) from ods_cthx_web_bas_comm_code partition(pt20190903000000) where c_par_cde = '601' order by c_cde 
...
from ods_cthx_web_ply_base partition(pt20190903000000)  a
        left join ods_cthx_web_app_insured partition(pt20190903000000)  id on a.c_app_no=id.c_app_no
        left join edw_cust_ply_party_applicant   partition(pt20190903000000) a1 on a.c_ply_no =a1.c_ply_no and a1.c_biz_type = 21  -- 10: 收款人, 21: 投保人, 22: 法人投保人, 31:被保人, 32:法人被保人, 33: 团单被保人，41: 受益人, 42: 法人受益人, 43: 团单受益人
        left join edw_cust_ply_party_insured   partition(pt20190903000000) i on a.c_ply_no =i.c_ply_no and i.c_biz_type = 31  -- 10: 收款人, 21: 投保人, 22: 法人投保人, 31:被保人, 32:法人被保人, 33: 团单被保人，41: 受益人, 42: 法人受益人, 43: 团单受益人        
        left join edw_cust_ply_party_bnfc   partition(pt20190903000000) b on a.c_ply_no =b.c_ply_no and b.c_biz_type in (41, 43)  -- 10: 收款人, 21: 投保人, 22: 法人投保人, 31:被保人, 32:法人被保人, 33: 团单被保人，41: 受益人, 42: 法人受益人, 43: 团单受益人
