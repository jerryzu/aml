...
alter table rpt_fxq_tb_ins_rchg_ms add partition (partition pt20190827000000 values less than ('{lastday}999999'));

alter table rpt_fxq_tb_ins_rchg_ms truncate partition pt20190827000000;
*/
