...
public class MyStringTrimmedResultSet implements InvocationHandler {
    ...
    /**
     * Constructs a new instance of <code>StringTrimmedResultSet</code> to wrap the
    ...
    /**
     * Intercept calls to the <code>getString()</code> and <code>getObject()</code>
     * methods and trim any Strings before they're returned.
     *
...
// ＆＆逻辑与　　｜｜逻辑或　　它们都是逻辑运算符
        ...
        if (args == null) {
            ...
            // System.out.println("invoke" + args.getClass() + method.getName()+(String)result);
